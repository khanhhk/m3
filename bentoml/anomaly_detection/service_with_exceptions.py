...
# Create our API with route /detection_with_exceptions
...
async def detection_with_exceptions(input_data: dict[str, float], ctx: bentoml.Context):
    ...
    if not isinstance(pred, pd.DataFrame):
        ...
        return "Hey there is something wrong with your prediction return type"
