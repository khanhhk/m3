...
svc = bentoml.Service("anomaly_detection_with_monitoring_demo", runners=[ad_runner])


# Create our API with route /detection_with_monitoring
...
async def detection_with_monitoring(input_data):
